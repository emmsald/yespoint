...
public class OperacionesController {
    ...
    public int cifrasreves(@RequestParam("num") int num) {
        return operacionesService.cifrasalreves(num);
    }

    @GetMapping("/Capicua")
    public String cifrascapicua(@RequestParam("num") int num) {
        return operacionesService.capicua(num);
    }

    @GetMapping("/Nocapicua")
    public String cifrasnocapicua(@RequestParam("num") int num) {
        return operacionesService.nocapicua(num);
    }

    @GetMapping("/Muestracalificacion")
    public String muestracalificacion(@RequestParam("nota") int nota) {
        return operacionesService.muestracalificacion(nota);
    }
}
